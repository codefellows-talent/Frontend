      ...
      <div>
        ...
        <div id="pictures-box">
          ...
          <div className="item">
            ...
            <p>Full Stack Javascript Developer, with a passion for making a difference</p>
            <h5>Ryan Felix</h5>
            <h6>Current Code Fellows Student</h6>
          </div>
          <div className="item">
        ...
        <div>
          <img className='landing-hero2' src='https://s3.amazonaws.com/codefellows-hiring-partners/helloquence-61189.jpg'/>
          <div id="take-a-look">
